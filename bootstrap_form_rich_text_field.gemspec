...
Gem::Specification.new do |spec|
  spec.name          = "bootstrap_form_rich_text_field"
  spec.version       = BootstrapFormRichTextField::VERSION
  spec.authors       = ["Ouvrages"]
  spec.email         = ["contact@ouvrages-web.fr"]

  spec.summary       = "BootstrapFormBuilder extension"
  spec.description   = "Add a rich_text_field to Bootstrap FormBuilder"
